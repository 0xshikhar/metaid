...
contract MetaIDNFT is ERC721URIStorage, Ownable {
    ...
    ) ERC721("MetaID", "AID") Ownable(msg.sender) {
        _tokenIdCounter = 1;
    ...
    function mintMetaID(
        ...
        require(
            ...
            "MetaID: User already has an NFT"
        );
        ...
        identities[newTokenId] = AgenticIdentity({
            metamaskCardVerified: _metamaskCardVerified,
    ...
    function updateIdentity(
        ...
        require(
            ...
            "MetaID: Nationality cannot be empty"
        );
    ...
    function updateVerificationStatus(
        ...
        identity.metamaskCardVerified = _metamaskCardVerified;
    ...
    function getIdentity(
        uint256 tokenId
    ) external view returns (AgenticIdentity memory) {
     ...
     * @notice Requires at least human verification (coin) and one other verification
     */
    function canParticipateInGovernance(
        address user
        ...
        // User must be metamask card verified AND have at least one other verification
        return
            identity.metamaskCardVerified &&
